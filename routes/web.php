...
Route::group(['as' => 'games.'], function() {
    ...
    Route::post('/comment', 'GameController@comment')->name('comment'); // Change the route name
...
Route::group(['as' => 'forum.', 'prefix' => 'forum'], function() {
    ...
    Route::get('my_posts', 'MyPostsController@index')->name('my_posts');
    ...
    Route::post('/bookmark/{threadId}', 'ForumController@bookmark')->name('bookmark');
    Route::get('/forum/drafts', [ForumDraftController::class, 'index'])->name('forum.drafts.index');
    Route::get('/forum/drafts/{id}', [ForumDraftController::class, 'show'])->name('forum.drafts.show');
    Route::delete('/forum/drafts/{id}', [ForumDraftController::class, 'destroy'])->name('forum.drafts.destroy');
});
...
Route::group(['as' => 'clans.', 'prefix' => 'clans'], function () {
    ...
    Route::post('/{id}/edit-thumbnail', 'ClanEditController@editThumbnail')->name('edit-thumbnail')->middleware('auth');
    Route::post('/{id}/transfer-ownership', 'ClanEditController@transferOwnership')->name('transfer-ownership')->middleware('auth');
    Route::post('/{id}/update-description', 'ClanEditController@updateDescription')->name('update-description')->middleware('auth');
    Route::post('/clans/{id}/edit-ranks', 'ClansController@editRanks')->name('clans.edit-ranks');
    Route::post('/{id}/create-new-rank', 'ClanEditController@createNewRank')->name('create-new-rank');
});
