...
class RegisterController extends Controller
{
    ...
    public function authenticate(Request $request)
    {
        ...
        $validate = [ // Fixed this horrible formatting, and made it so ya can use spaces, - and .
            'username' => [
                'required',
                'min:2',
                'max:26',
        ...
        if (config('app.env') == 'production' && $accountsWithSameIP >= 2)
            return back()->withErrors(['You have reached the limit of 2 accounts.']);
        ...
        $user->currency_bits = 10; // Remove later, ok? Yeah, Sure lol - Hurricane
